...
import com.example.gufyguber.Singletons.FirebaseManager.ReturnValueListener;
...
public class DirectionsAPIHandler {
    ...
    private static class FetchDirectionsTask extends AsyncTask<String, Void, String> {
        ReturnValueListener<ArrayList<LatLng>> onComplete;
         ...
         */
        public FetchDirectionsTask(ReturnValueListener<ArrayList<LatLng>> onComplete) { this.onComplete = onComplete; }
